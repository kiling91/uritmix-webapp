    ...
    return (
        <div className="card">
                    ...
                    <div className="d-flex justify-content-between">
                        <Tooltip tooltip={'Create customer'}>
                            <Button icon="plus" type="default"
                                    text="Create customer" className={"mx-1"} onClick={onCreateCustomer} />
                        </Tooltip>
                        <Tooltip tooltip={'Create trainer'}>
                            <Button icon="plus" type="success"
                                    text="Create trainer" className={"mx-1"} onClick={onCreateTrainer} />
                        </Tooltip>
                        <TextBox
                            mode="text"
            ...
            <div className="card-body">
                {personsTable}
                {/*Modal*/}
                <Visibility visible={modalMode == ModalMode.CreateTrainer || modalMode == ModalMode.CreateCustomer}>
                    <CreatePerson onClose={onCloseModal} isTrainer={modalMode == ModalMode.CreateTrainer}/>
                </Visibility>
                {/*Modal*/}
            </div>
        </div>
